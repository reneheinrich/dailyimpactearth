...
function finalScore () {
    ...
    if (score >= 4 ) {
        ...
        let shareTwitter =("<a href='http://twitter.com/share?text=" +score + " von 5 Punkten. " + "Ich bin " + endText[2].Name + ". Schaffst du beim Umwelt-Quiz mehr Punkte als ich?" + "&amp;url=https://dailyimpact.earth/impact-quiz/quiz/&amp;hashtags=dailyimpact,quiz,nachhaltig'><i class='fab fa-twitter-square' aria-hidden='true'></i></a>").toString();
